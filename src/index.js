...
import parentRoutes from './routes/parentRoutes.js'; // ✅ Parent routes
import errorHandler from './middlewares/errorHandler.js';
import createUserTable from './data/createUserTable.js';
// import createParentsTable from './data/createParentsTable.js';
...
app.use('/api/parent', parentRoutes); // ✅ Example: http://localhost:3001/api/parent
app.use('/api', dailyRecordRoutes);
// Error handling middleware
app.use(errorHandler);
